sap.ui.define([
    ...
    return BaseController.extend("be.ap.sap.studentapp2.controller.Detail", {
        ...
        _onObjectMatched: function (oEvent) {
            ...
            if (sObjectId === 'new') {
                ...
                const bindingContext = model.createEntry('/StudentSet', {
                    properties: {
                        LastName: '',
                        FirstName: '',
                        Birthdate: '',
                ...
                this.getModel().metadataLoaded().then(function () {
                    var sObjectPath = model.createKey("StudentSet", {
                        Id: sObjectId
                    });
