		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#beapsapstudentapp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"beapsapstudentapp2-display": {
								"semanticObject": "beapsapstudentapp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=be.ap.sap.studentapp2",
									"url": sap.ui.require.toUrl("be/ap/sap/studentapp2")
								}
							}
						}
					}
